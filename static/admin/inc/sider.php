...
<div class="aside">
    <div class="profile">
      <img class="avatar" src="<?php echo $user_date['avatar']; ?>">
      <h3 class="name"><?php echo $user_date['nickname']; ?></h3>
    </div>
    <ul class="nav">
      <li<?php echo $current_index == 'index' ? " class='active'" : '' ?>>
        <a href="index.php"><i class="fa fa-dashboard"></i>仪表盘</a>
      </li>
      <?php $arry_post=['posts','post-add','categories'] ?>
      <li<?php echo  in_array($current_index, $arry_post) ? " class='active'" : '' ?>>
        <a href="#menu-posts" class="collapsed" data-toggle="collapse">
          <i class="fa fa-thumb-tack"></i>文章<i class="fa fa-angle-right"></i>
        </a>
        <ul id="menu-posts" class="collapse<?php echo  in_array($current_index, $arry_post) ? " in" : '' ?>">
      ...
      <?php $arry_set=['nav-menus','slides','settings'] ?>
      <li<?php echo in_array($current_index,$arry_set) ? " class='active'" : '' ?>>
        <a href="#menu-settings" class="collapsed" data-toggle="collapse">
          <i class="fa fa-cogs"></i>设置<i class="fa fa-angle-right"></i>
        </a>
        <ul id="menu-settings" class="collapse<?php echo in_array($current_index,$arry_set) ? " in" : '' ?>">
